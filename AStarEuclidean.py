...
path, pathDirections = AStarEuclideanMethod.getPath()
    
print(path)
print(pathDirections)   
print(AStarEuclideanMethod.getMaxDepth())
print(AStarEuclideanMethod.getNodesExpanded()) 
print(AStarEuclideanMethod.getCostOfPath()) 
